...
WTD_PROV_FLAGS_MASK = make_flag("WTD_PROV_FLAGS_MASK", 0x0000FFFF)
WTD_USE_IE4_TRUST_FLAG = make_flag("WTD_USE_IE4_TRUST_FLAG", 0x00000001)
WTD_NO_IE4_CHAIN_FLAG = make_flag("WTD_NO_IE4_CHAIN_FLAG", 0x00000002)
WTD_NO_POLICY_USAGE_FLAG = make_flag("WTD_NO_POLICY_USAGE_FLAG", 0x00000004)
WTD_REVOCATION_CHECK_NONE = make_flag("WTD_REVOCATION_CHECK_NONE", 0x00000010)
WTD_REVOCATION_CHECK_END_CERT = make_flag("WTD_REVOCATION_CHECK_END_CERT", 0x00000020)
WTD_REVOCATION_CHECK_CHAIN = make_flag("WTD_REVOCATION_CHECK_CHAIN", 0x00000040)
WTD_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT = make_flag("WTD_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT", 0x00000080)
WTD_SAFER_FLAG = make_flag("WTD_SAFER_FLAG", 0x00000100)
WTD_HASH_ONLY_FLAG = make_flag("WTD_HASH_ONLY_FLAG", 0x00000200)
WTD_USE_DEFAULT_OSVER_CHECK = make_flag("WTD_USE_DEFAULT_OSVER_CHECK", 0x00000400)
WTD_LIFETIME_SIGNING_FLAG = make_flag("WTD_LIFETIME_SIGNING_FLAG", 0x00000800)
WTD_CACHE_ONLY_URL_RETRIEVAL = make_flag("WTD_CACHE_ONLY_URL_RETRIEVAL", 0x00001000)
WTD_DISABLE_MD2_MD4 = make_flag("WTD_DISABLE_MD2_MD4", 0x00002000)
WTD_MOTW = make_flag("WTD_MOTW", 0x00004000)
WTD_CODE_INTEGRITY_DRIVER_MODE = make_flag("WTD_CODE_INTEGRITY_DRIVER_MODE", 0x00008000)
WSS_VERIFY_SPECIFIC = make_flag("WSS_VERIFY_SPECIFIC", 0x00000001)
WSS_GET_SECONDARY_SIG_COUNT = make_flag("WSS_GET_SECONDARY_SIG_COUNT", 0x00000002)
WSS_VERIFY_SEALING = make_flag("WSS_VERIFY_SEALING", 0x00000004)
WSS_INPUT_FLAG_MASK = make_flag("WSS_INPUT_FLAG_MASK", 0x00000007)
WSS_OUT_SEALING_STATUS_VERIFIED = make_flag("WSS_OUT_SEALING_STATUS_VERIFIED", 0x80000000)
WSS_OUT_HAS_SEALING_INTENT = make_flag("WSS_OUT_HAS_SEALING_INTENT", 0x40000000)
WSS_OUT_FILE_SUPPORTS_SEAL = make_flag("WSS_OUT_FILE_SUPPORTS_SEAL", 0x20000000)
WSS_OUTPUT_FLAG_MASK = make_flag("WSS_OUTPUT_FLAG_MASK", 0xe0000000)
CPD_UISTATE_MODE_PROMPT = make_flag("CPD_UISTATE_MODE_PROMPT", 0x00000000)
CPD_UISTATE_MODE_BLOCK = make_flag("CPD_UISTATE_MODE_BLOCK", 0x00000001)
CPD_UISTATE_MODE_ALLOW = make_flag("CPD_UISTATE_MODE_ALLOW", 0x00000002)
CPD_UISTATE_MODE_MASK = make_flag("CPD_UISTATE_MODE_MASK", 0x00000003)
CPD_USE_NT5_CHAIN_FLAG = make_flag("CPD_USE_NT5_CHAIN_FLAG", 0x80000000)
CPD_REVOCATION_CHECK_NONE = make_flag("CPD_REVOCATION_CHECK_NONE", 0x00010000)
CPD_REVOCATION_CHECK_END_CERT = make_flag("CPD_REVOCATION_CHECK_END_CERT", 0x00020000)
CPD_REVOCATION_CHECK_CHAIN = make_flag("CPD_REVOCATION_CHECK_CHAIN", 0x00040000)
CPD_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT = make_flag("CPD_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT", 0x00080000)
CPD_RETURN_LOWER_QUALITY_CHAINS = make_flag("CPD_RETURN_LOWER_QUALITY_CHAINS", 0x00100000)
CPD_CHOICE_SIP = make_flag("CPD_CHOICE_SIP", 1)
SGNR_TYPE_TIMESTAMP = make_flag("SGNR_TYPE_TIMESTAMP", 0x00000010)
MSSIP_ADDINFO_NONE = make_flag("MSSIP_ADDINFO_NONE", 0)
MSSIP_ADDINFO_FLAT = make_flag("MSSIP_ADDINFO_FLAT", 1)
MSSIP_ADDINFO_CATMEMBER = make_flag("MSSIP_ADDINFO_CATMEMBER", 2)
MSSIP_ADDINFO_BLOB = make_flag("MSSIP_ADDINFO_BLOB", 3)
MSSIP_ADDINFO_NONMSSIP = make_flag("MSSIP_ADDINFO_NONMSSIP", 500)
CERT_CONFIDENCE_SIG = make_flag("CERT_CONFIDENCE_SIG", 0x10000000)
CERT_CONFIDENCE_TIME = make_flag("CERT_CONFIDENCE_TIME", 0x01000000)
CERT_CONFIDENCE_TIMENEST = make_flag("CERT_CONFIDENCE_TIMENEST", 0x00100000)
CERT_CONFIDENCE_AUTHIDEXT = make_flag("CERT_CONFIDENCE_AUTHIDEXT", 0x00010000)
CERT_CONFIDENCE_HYGIENE = make_flag("CERT_CONFIDENCE_HYGIENE", 0x00001000)
CERT_CONFIDENCE_HIGHEST = make_flag("CERT_CONFIDENCE_HIGHEST", 0x11111000)
