...
PFN_PROVUI_CALL = PVOID
PFN_CPD_MEM_ALLOC = PVOID
PFN_CPD_MEM_FREE = PVOID
PFN_CPD_ADD_STORE = PVOID
PFN_CPD_ADD_SGNR = PVOID
PFN_CPD_ADD_CERT = PVOID
PFN_CPD_ADD_PRIVDATA = PVOID
PFN_PROVIDER_INIT_CALL = PVOID
PFN_PROVIDER_OBJTRUST_CALL = PVOID
PFN_PROVIDER_SIGTRUST_CALL = PVOID
PFN_PROVIDER_CERTTRUST_CALL = PVOID
PFN_PROVIDER_CERTCHKPOLICY_CALL = PVOID
PFN_PROVIDER_FINALPOLICY_CALL = PVOID
PFN_PROVIDER_TESTFINALPOLICY_CALL = PVOID
PFN_PROVIDER_CLEANUP_CALL = PVOID
pCryptSIPGetSignedDataMsg = PVOID
pCryptSIPPutSignedDataMsg = PVOID
pCryptSIPCreateIndirectData = PVOID
pCryptSIPVerifyIndirectData = PVOID
pCryptSIPRemoveSignedDataMsg = PVOID
LPCONTEXT = PVOID
HCERTSTORE = PVOID
HCRYPTMSG = PVOID
...
class WINTRUST_SIGNATURE_SETTINGS_(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("dwIndex", DWORD),
        ("dwFlags", DWORD),
...
PWINTRUST_SIGNATURE_SETTINGS = POINTER(WINTRUST_SIGNATURE_SETTINGS_)
...
class _WINTRUST_DATA(Structure):
    _fields_ = [
        ...
        ("dwProvFlags", DWORD),
        ("dwUIContext", DWORD),
        ("pSignatureSettings", POINTER(WINTRUST_SIGNATURE_SETTINGS_)),
    ]
...
class _CRYPT_PROVUI_DATA(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("dwFinalError", DWORD),
        ("pYesButtonText", POINTER(WCHAR)),
        ("pNoButtonText", POINTER(WCHAR)),
        ("pMoreInfoButtonText", POINTER(WCHAR)),
        ("pAdvancedLinkText", POINTER(WCHAR)),
        ("pCopyActionText", POINTER(WCHAR)),
        ("pCopyActionTextNoTS", POINTER(WCHAR)),
        ("pCopyActionTextNotSigned", POINTER(WCHAR)),
    ]
PCRYPT_PROVUI_DATA = POINTER(_CRYPT_PROVUI_DATA)
CRYPT_PROVUI_DATA = _CRYPT_PROVUI_DATA

class _CRYPT_PROVUI_FUNCS(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("psUIData", POINTER(_CRYPT_PROVUI_DATA)),
...
CRYPT_PROVUI_FUNCS = _CRYPT_PROVUI_FUNCS
PCRYPT_PROVUI_FUNCS = POINTER(_CRYPT_PROVUI_FUNCS)

class _CRYPT_PROVIDER_PRIVDATA(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("gProviderID", GUID),
        ("cbProvData", DWORD),
        ("pvProvData", POINTER(VOID)),
    ]
CRYPT_PROVIDER_PRIVDATA = _CRYPT_PROVIDER_PRIVDATA
PCRYPT_PROVIDER_PRIVDATA = POINTER(_CRYPT_PROVIDER_PRIVDATA)

class _CRYPT_PROVIDER_FUNCTIONS(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ...
        ("psUIpfns", POINTER(_CRYPT_PROVUI_FUNCS)),
        ("pfnCleanupPolicy", PFN_PROVIDER_CLEANUP_CALL),
    ]
CRYPT_PROVIDER_FUNCTIONS = _CRYPT_PROVIDER_FUNCTIONS
PCRYPT_PROVIDER_FUNCTIONS = POINTER(_CRYPT_PROVIDER_FUNCTIONS)

class SIP_DISPATCH_INFO_(Structure):
    _fields_ = [
        ("cbSize", DWORD),
        ("hSIP", HANDLE),
...
SIP_DISPATCH_INFO = SIP_DISPATCH_INFO_
LPSIP_DISPATCH_INFO = POINTER(SIP_DISPATCH_INFO_)

class MS_ADDINFO_FLAT_(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("pIndirectData", POINTER(SIP_INDIRECT_DATA_)),
    ]
PMS_ADDINFO_FLAT = POINTER(MS_ADDINFO_FLAT_)
MS_ADDINFO_FLAT = MS_ADDINFO_FLAT_

class MS_ADDINFO_BLOB_(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("cbMemObject", DWORD),
        ("pbMemObject", POINTER(BYTE)),
...
PMS_ADDINFO_BLOB = POINTER(MS_ADDINFO_BLOB_)
MS_ADDINFO_BLOB = MS_ADDINFO_BLOB_

class CRYPTCATSTORE_(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
...
class MS_ADDINFO_CATALOGMEMBER_(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("pStore", POINTER(CRYPTCATSTORE_)),
        ("pMember", POINTER(CRYPTCATMEMBER_)),
    ]
MS_ADDINFO_CATALOGMEMBER = MS_ADDINFO_CATALOGMEMBER_
PMS_ADDINFO_CATALOGMEMBER = POINTER(MS_ADDINFO_CATALOGMEMBER_)

class _TMP_SIP_SUBJECTINFO_UNION_TYPE(Union):
    _fields_ = [
        ("psFlat", POINTER(MS_ADDINFO_FLAT_)),
        ("psCatMember", POINTER(MS_ADDINFO_CATALOGMEMBER_)),
        ("psBlob", POINTER(MS_ADDINFO_BLOB_)),
    ]
TMP_SIP_SUBJECTINFO_UNION_TYPE = _TMP_SIP_SUBJECTINFO_UNION_TYPE

class SIP_SUBJECTINFO_(Structure):
    _fields_ = [
        ("cbSize", DWORD),
        ...
        ("dwIndex", DWORD),
        ("dwUnionChoice", DWORD),
        ("tmp_union", TMP_SIP_SUBJECTINFO_UNION_TYPE),
        ("pClientData", LPVOID),
    ]
LPSIP_SUBJECTINFO = POINTER(SIP_SUBJECTINFO_)
SIP_SUBJECTINFO = SIP_SUBJECTINFO_

class _PROVDATA_SIP(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("gSubject", GUID),
        ("pSip", POINTER(SIP_DISPATCH_INFO_)),
        ("pCATSip", POINTER(SIP_DISPATCH_INFO_)),
        ("psSipSubjectInfo", POINTER(SIP_SUBJECTINFO_)),
        ("psSipCATSubjectInfo", POINTER(SIP_SUBJECTINFO_)),
        ("psIndirectData", POINTER(SIP_INDIRECT_DATA_)),
    ]
PROVDATA_SIP = _PROVDATA_SIP
PPROVDATA_SIP = POINTER(_PROVDATA_SIP)

class _CRYPT_PROVIDER_CERT(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ...
        ("dwConfidence", DWORD),
        ("dwError", DWORD),
        ("pTrustListContext", POINTER(CTL_CONTEXT)),
...
PCRYPT_PROVIDER_CERT = POINTER(_CRYPT_PROVIDER_CERT)

# Self referencing struct tricks
class _CRYPT_PROVIDER_SGNR(Structure): pass
CRYPT_PROVIDER_SGNR = _CRYPT_PROVIDER_SGNR
PCRYPT_PROVIDER_SGNR = POINTER(_CRYPT_PROVIDER_SGNR)
_CRYPT_PROVIDER_SGNR._fields_ = [
    ("cbStruct", DWORD),
    ("sftVerifyAsOf", FILETIME),
    ("csCertChain", DWORD),
    ("pasCertChain", POINTER(_CRYPT_PROVIDER_CERT)),
    ("dwSignerType", DWORD),
    ("psSigner", POINTER(CMSG_SIGNER_INFO)),
    ("dwError", DWORD),
    ("csCounterSigners", DWORD),
    ("pasCounterSigners", POINTER(_CRYPT_PROVIDER_SGNR)),
    ("pChainContext", PCCERT_CHAIN_CONTEXT),
]

class _SEALING_SIGNATURE_ATTRIBUTE(Structure):
    _fields_ = [
        ("version", ULONG),
        ("signerIndex", ULONG),
        ("signatureAlgorithm", CRYPT_ALGORITHM_IDENTIFIER),
...
PSEALING_SIGNATURE_ATTRIBUTE = POINTER(_SEALING_SIGNATURE_ATTRIBUTE)
SEALING_SIGNATURE_ATTRIBUTE = _SEALING_SIGNATURE_ATTRIBUTE

class _CRYPT_PROVIDER_SIGSTATE(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("rhSecondarySigs", POINTER(HCRYPTMSG)),
        ...
        ("pSealingSignature", POINTER(_SEALING_SIGNATURE_ATTRIBUTE)),
    ]
CRYPT_PROVIDER_SIGSTATE = _CRYPT_PROVIDER_SIGSTATE
PCRYPT_PROVIDER_SIGSTATE = POINTER(_CRYPT_PROVIDER_SIGSTATE)

class _TMP_PROVDATA_SIP(Union):
    _fields_ = [
        ("pPDSip", POINTER(_PROVDATA_SIP)),
    ]
TMP_PROVDATA_SIP = _TMP_PROVDATA_SIP

class _CRYPT_PROVIDER_DATA(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ("pWintrustData", POINTER(WINTRUST_DATA)),
        ("fOpenedFile", BOOL),
        ("hWndParent", HWND),
        ...
        ("psPfns", POINTER(_CRYPT_PROVIDER_FUNCTIONS)),
        ("cdwTrustStepErrors", DWORD),
        ("padwTrustStepErrors", POINTER(DWORD)),
        ("chStores", DWORD),
        ("pahStores", POINTER(HCERTSTORE)),
        ("dwEncoding", DWORD),
        ("hMsg", HCRYPTMSG),
        ("csSigners", DWORD),
        ("pasSigners", POINTER(_CRYPT_PROVIDER_SGNR)),
        ("csProvPrivData", DWORD),
        ("pasProvPrivData", POINTER(_CRYPT_PROVIDER_PRIVDATA)),
        ("dwSubjectChoice", DWORD),
        ("tmp_union", TMP_PROVDATA_SIP),
        ("pszUsageOID", POINTER(CHAR)),
        ("fRecallWithState", BOOL),
        ("sftSystemTime", FILETIME),
        ("pszCTLSignerUsageOID", POINTER(CHAR)),
        ("dwProvFlags", DWORD),
        ("dwFinalError", DWORD),
        ("pRequestUsage", PCERT_USAGE_MATCH),
        ("dwTrustPubSettings", DWORD),
        ("dwUIStateFlags", DWORD),
        ("pSigState", POINTER(_CRYPT_PROVIDER_SIGSTATE)),
        ("pSigSettings", POINTER(WINTRUST_SIGNATURE_SETTINGS_)),
    ]
PCRYPT_PROVIDER_DATA = POINTER(_CRYPT_PROVIDER_DATA)
CRYPT_PROVIDER_DATA = _CRYPT_PROVIDER_DATA

class DRIVER_VER_MAJORMINOR_(Structure):
    _fields_ = [
        ("dwMajor", DWORD),
        ("dwMinor", DWORD),
    ]
...
class DRIVER_VER_INFO_(Structure):
    _fields_ = [
        ("cbStruct", DWORD),
        ...
        ("dwPlatform", DWORD),
        ("dwVersion", DWORD),
        ("wszVersion", WCHAR * (MAX_PATH)),
        ("wszSignedBy", WCHAR * (MAX_PATH)),
        ("pcSignerCertContext", PCCERT_CONTEXT),
        ("sOSVersionLow", DRIVER_VER_MAJORMINOR),
        ("sOSVersionHigh", DRIVER_VER_MAJORMINOR),
        ("dwBuildNumberLow", DWORD),
        ("dwBuildNumberHigh", DWORD),
    ]
PDRIVER_VER_INFO = POINTER(DRIVER_VER_INFO_)
